...
# from third_party.diffusers29.utils.torch_utils import randn_tensor # Refactored to use installed diffusers
from diffusers.utils import randn_tensor # Use installed diffusers utility
